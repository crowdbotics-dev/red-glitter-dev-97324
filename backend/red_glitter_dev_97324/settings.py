"""
Django settings for red_glitter_dev_97324 project.
...
ROOT_URLCONF = 'red_glitter_dev_97324.urls'
...
WSGI_APPLICATION = 'red_glitter_dev_97324.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "red_glitter_dev_97324 API",
    "DESCRIPTION": "API documentation for red_glitter_dev_97324 App",
    "VERSION": "v1",
}
